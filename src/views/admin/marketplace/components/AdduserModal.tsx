...
export const AdduserModal = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const response = await axios.post(
        "http://ec2-65-1-183-77.ap-south-1.compute.amazonaws.com:8181/api/v1/auth/signup",
        userData
      );
  ...
  return (
    <div>
      <h2 className="mt-5 pt-32 text-4xl font-semibold text-gray-800">
        Add User
      </h2>
      <form className="w-full p-4 md:w-1/2 lg:w-1/3" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-wrap">
          <label htmlFor="is_verified" className="mb-2 block w-full md:w-1/4">
            Verified:
          </label>
          <input
            checked={true}
        ...
        <div className="flex flex-wrap">
          ...
          <input
            ...
            name="partner_bodyColor"
            onChange={handleChange}
          />
        </div>
        <div className="flex flex-wrap">
          <label htmlFor="partner_min_height">
            Partner Minimum Height (cm):
          </label>
          <input
            className="bg-gray-50ring-0 border-neutral-500 text-neutral-900 placeholder-violet-700 focus:ring-violet-500 focus:border-violet-500 checked:bg-emerald-500 relative mx-5 my-3  block w-64 rounded-lg border p-2.5 text-sm outline-none"
            type="number"
        ...
        <div className="flex flex-wrap">
          <label htmlFor="partner_max_height">
            Partner Maximum Height (cm):
          </label>
          <input
            className="bg-gray-50ring-0 border-neutral-500 text-neutral-900 placeholder-violet-700 focus:ring-violet-500 focus:border-violet-500 checked:bg-emerald-500 relative mx-5 my-3  block w-64 rounded-lg border p-2.5 text-sm outline-none"
            type="number"
        ...
        <div className="flex flex-wrap">
          <label htmlFor="partner_min_weight">
            Partner Minimum Weight (kg):
          </label>
          <input
            className="bg-gray-50ring-0 border-neutral-500 text-neutral-900 placeholder-violet-700 focus:ring-violet-500 focus:border-violet-500 checked:bg-emerald-500 relative mx-5 my-3  block w-64 rounded-lg border p-2.5 text-sm outline-none"
            type="number"
            id="partner_min_weight"
            name="partner_min_weight"
            onChange={handleChange}
          />
        </div>
        <div className="flex flex-wrap">
          <label htmlFor="partner_max_weight">
            Partner Maximum Weight (kg):
          </label>
          <input
            className="bg-gray-50ring-0 border-neutral-500 text-neutral-900 placeholder-violet-700 focus:ring-violet-500 focus:border-violet-500 checked:bg-emerald-500 relative mx-5 my-3  block w-64 rounded-lg border p-2.5 text-sm outline-none"
            type="number"
            id="partner_max_weight"
        ...
        <div className="flex flex-wrap">
          <label htmlFor="partner_islamic_education">
            Partner Islamic Education:
          </label>
          <input
            className="bg-gray-50ring-0 border-neutral-500 text-neutral-900 placeholder-violet-700 focus:ring-violet-500 focus:border-violet-500 checked:bg-emerald-500 relative mx-5 my-3  block w-64 rounded-lg border p-2.5 text-sm outline-none"
            type="text"
            id="partner_islamic_education"
            name="partner_islamic_education"
            onChange={handleChange}
          />
        </div>
        <div className="flex flex-wrap">
        ...
        <div className="flex flex-wrap">
          <label htmlFor="partner_hajab_maintain">
            Partner Hajab Maintain:
          </label>
          <input
            className="bg-gray-50ring-0 border-neutral-500 text-neutral-900 placeholder-violet-700 focus:ring-violet-500 focus:border-violet-500 checked:bg-emerald-500 relative mx-5 my-3  block w-64 rounded-lg border p-2.5 text-sm outline-none"
            type="text"
            id="partner_hajab_maintain"
            name="partner_hajab_maintain"
            onChange={handleChange}
          />
        </div>
        <div className="flex flex-wrap">
          ...
          <input
            ...
            name="partner_religious"
            onChange={handleChange}
          />
        </div>
        <div className="flex flex-wrap">
          <label htmlFor="partner_marital_status">
