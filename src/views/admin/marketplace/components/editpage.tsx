...
function Editpage({userObjectId}:any) {
  ...
  const handleSubmit = async (event:any) => {
    ...
    try {
      const response = await axios.patch('http://ec2-65-1-183-77.ap-south-1.compute.amazonaws.com:8181/api/v1/user/update-user-details', {
